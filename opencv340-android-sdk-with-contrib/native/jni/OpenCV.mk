...
OPENCV_MODULES:=stitching superres videostab aruco bgsegm bioinspired ccalib dpm face photo fuzzy img_hash line_descriptor optflow reg rgbd saliency stereo structured_light phase_unwrapping surface_matching text tracking dnn plot xfeatures2d shape video ml ximgproc calib3d features2d highgui videoio flann xobjdetect imgcodecs objdetect xphoto imgproc core
