...
OPENCV_MODULES:=calib3d core dnn features2d flann highgui imgcodecs imgproc ml objdetect photo shape stitching superres video videoio videostab aruco bgsegm bioinspired ccalib dnn_objdetect dpm face fuzzy hfs img_hash world line_descriptor optflow phase_unwrapping plot reg rgbd saliency stereo structured_light surface_matching text tracking xfeatures2d ximgproc xobjdetect xphoto
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=calib3d core dnn features2d flann highgui imgcodecs imgproc ml objdetect photo shape stitching superres video videoio videostab aruco bgsegm bioinspired ccalib dnn_objdetect dpm face fuzzy hfs img_hash world line_descriptor optflow phase_unwrapping plot reg rgbd saliency stereo structured_light surface_matching text tracking xfeatures2d ximgproc xobjdetect xphoto
    OPENCV_LIB_TYPE:=SHARED
else
